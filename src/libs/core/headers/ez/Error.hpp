...
#define EZ_ERROR_INFO_INPLACE(Enum, Name, value_to_message)                   \
    template <>                                                               \
    inline const ErrorInfo* error_info<Enum>() noexcept                       \
    {                                                                         \
...
#define EZ_ERROR_INFO(Enum, Name, value_to_message)     \
    namespace ez {                                      \
    EZ_ERROR_INFO_INPLACE(Enum, Name, value_to_message) \
    }
